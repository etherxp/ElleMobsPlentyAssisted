...
public class AncientFurnaceRecipe extends AbstractCookingRecipe {
  public AncientFurnaceRecipe(ResourceLocation pId, String pGroup,
  ...
  public ItemStack getToastSymbol() {
    return new ItemStack(ModBlocks.ANCIENT_FURNACE_BLOCK.get());
  }
  ...
  public static class Serializer implements RecipeSerializer<AncientFurnaceRecipe> {
    private final int defaultCookingTime;
    public static final AncientFurnaceRecipe.Serializer INSTANCE = new Serializer(50);
    ...
    public AncientFurnaceRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
      ...
      return new AncientFurnaceRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
    }

    public AncientFurnaceRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
    ...
    public void toNetwork(FriendlyByteBuf pBuffer, AncientFurnaceRecipe pRecipe) {
